 ...
 * @version 21/06/2013
 * 
 * El tablero generado por la maquina esta aqui, ojo q solo lo genera en su turno
 * q es del jugador2
 * 
 * Los disparos al random tambien estan
 * 
 * */
...
public class Juego {
	...
	public Juego(boolean twoPlayers){
	...
	public static void main(String[] args){
		Juego juego = new Juego(true);//al principio el turno es del jugador1
		juego.setTurno();//ahora el turno es del jugador2 q seria la compu
		juego.generarTablero();//solo puede generar en su turno
		//repìto 2 veces para q dispare en su propio tablero
		juego.setTurno();//turno jugador1
		juego.setTurno();//turno jugador2
		System.out.println("cantidad buques Jug2: "+juego.getcantidadBuquesJug2());
		/** estan por numeros porq de esa forma pude pintarlos, cada color es un
		* 	estado:
		* 	0 agua (no existe nada)
		* 	1 parte barco sanito
		* 	2 parte barco dañado
		...
		*   */
		...
		//juego.printPositionsOfSub(200);// imprime las posiciones para una cantidad
										 // de 200 
	}
